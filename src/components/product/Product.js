...
const Product = () => {
    ...
    return (
        ...
        <div className='prod-items'>
            <div >
                <h4  className='about-item-title'>{cars.title}</h4>
                <img src={"../"+cars.image2} alt="error" className="about-item-image" />
                <h3 className='setting-title'>DESIGN</h3>
                <p className='about-item'>{cars.settings}</p>
                <img src={"../"+cars.image3} alt="error" className="performance-image" />
                <h3 className='setting-title-2'>PERFORMANCE</h3>
                <p className='about-item'>{cars.performance}</p>
